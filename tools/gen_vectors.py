...
CASES = [
    ...
    "Ελληνικά κείμενο δοκιμή", "Привет, мир! Как дела?",
    "العربية نص تجريبي", "עברית טקסט לבדיקה",
    "日本語のテキストです。これはテストです。", "中文测试文本，包含标点符号。",
    "한국어 텍스트 테스트입니다", "ไทย ภาษาไทย ทดสอบ",
    "亚洲AV 中文AB混合Test", "ＡＢＣ ｆｕｌｌｗｉｄｔｈ １２３",
    "🚀🎉😀 emoji test 👨‍👩‍👧‍👦 🇺🇸🇯🇵 🏳️‍🌈",
    "combining: é à ñ ö", "zero​width​space",
    "math: ∑∫∂√∞ ≠ ≤ ≥ α β γ", "box: ┌─┬─┐ │ └─┴─┘", "\x00\x01\x02 control bytes \x7f",
    "MiXeDcAsE CamelCase snake_case SCREAMING_SNAKE kebab-case",
    "ALLUPPER lower Mixed123Digits", "AAA bbb CCCddd EEEfff",
    "a" * 300, "ab" * 200, "word " * 100, "日本" * 100,
    "<|endoftext|>", "text <|endoftext|> more", "<|fim_prefix|>x<|fim_suffix|>y<|fim_middle|>",
    "{'json': [1, 2, {'nested': null}], \"other\": true}",
    "\\n\\t escaped \\\\ backslash", "```python\nprint('hi')\n```",
    "# Heading\n\n- bullet\n- list\n\n> quote\n",
    "tabs\tbetween\twords", "trailing newline\n", "\n leading newline",
    "one/two/three//four", "path\\to\\file.txt", "a,b,,c,,,d",
    "!!!???...---___+++", "(((nested)))[[[brackets]]]{{{braces}}}",
    "🚀start", "end🚀", "mid🚀dle", " 🚀 ",
]
